# -*- coding: utf-8 -*-
"""Cópia_de_Aula1_Introducao_ao_Python.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/JuBertoldo/Senac_python/blob/GitHub-Pages/C%C3%B3pia_de_Aula1_Introducao_ao_Python.ipynb
...
deposito = float(input("Informe o valor do depósito bancário: "))
juros_anual = float(input("Informe o valor do juros anual: "))

print(f"O valor do depósito bancário é: R${deposito}")
print(f"O valor do juros anual é: R${juros_anual}")

juros_compostos1 = deposito * (1 + (juros_anual / 100)) ** 1
juros_compostos3 = deposito * (1 + (juros_anual / 100)) ** 5
juros_compostos10 = deposito * (1 + (juros_anual / 100)) ** 10

print(f"O valor do depósito bancário após 1 ano é: R${juros_compostos1:.2f}")
print(f"O valor do depósito bancário após 3 anos é: R${juros_compostos3:.2f}")
print(f"O valor do depósito bancário após 10 anos é: R${juros_compostos10:.2f}")
...
valor_reajuste = float(salario_reajuste - salario)

print(f"O valor do seu salário era R${salario}.\n Parabéns você teve um reajuste salarial de {perc_aumento}% e seu novo salário depois do reajuste e no valor R${salario_reajuste:.2f} \n Você teve um aumeto salrial no valor R$ {valor_reajuste}")